...
db.session.commit()
report1 = Report(patient_id= 3,doctor_id = 1,title= "titlekosomk" ,statement= "213126534643567345he will die soon")
report2 = Report(patient_id= 3,doctor_id = 2,title='titlekosomen1231 omk' ,statement= "3213al23mar bed allah")
report3 = Report(patient_id= 3,doctor_id = 1,title= "titlekosom231k" ,statement= "123312he will die soon")
report4 = Report(patient_id= 3,doctor_id = 2,title='titlekosom35en omk' ,statement= "12374al23mar bed allah")
report5 = Report(patient_id= 3,doctor_id = 1,title= "titlekos546omk" ,statement= "678679078he will die soon")
report6 = Report(patient_id= 3,doctor_id = 2,title='titlekos456omen omk' ,statement= "678677al23mar bed allah")
report7 = Report(patient_id= 3,doctor_id = 1,title= "titleko546somk" ,statement= "6786897978he will die soon")
report8 = Report(patient_id= 3,doctor_id = 2,title='titlekos745omen omk' ,statement= "67867al23mar bed allah")
report9 = Report(patient_id= 3,doctor_id = 1,title= "titleko867somk" ,statement= "67823423467he will die soon")
report0 = Report(patient_id= 3,doctor_id = 2,title='titlekos768678omen omk' ,statement= "678678al23mar bed allah")
